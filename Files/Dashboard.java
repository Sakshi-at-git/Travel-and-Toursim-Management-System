...
public class Dashboard extends JFrame implements ActionListener{
    ...
    String username;
    JButton addPersonalDetails,viewPersonalDetails,updatePersonalDetails,checkpackages,bookpackage,viewpackage,viewhotels,destinations,bookhotel,viewbookedhotel;
    Dashboard(String username){
     ...
     //   setBounds(0,0,1600,1000);
        ...
        checkpackages.setMargin(new Insets(0,0,0,30));
